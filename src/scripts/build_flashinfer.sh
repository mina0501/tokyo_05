...
# set here single cuda architecture for which to compile flashinfer
...
pip install build wheel setuptools ninja psutil packaging einops numpy apache-tvm-ffi==0.1.3
python -m flashinfer.aot --out-dir /workspace/compiled_wheels
